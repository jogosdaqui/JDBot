...
namespace JDBot.Tests.Infrastructure.Extractors
{
    ...
    public class WordPressPostExtractorTest
    {
        ...
        public async Task Extract_IsSimplePageUrl_Post()
        {
            ...
            StringAssert.StartsWith("[Trilha Ecológica](http://www.monsterbed.com.br/games/trilha-ecologica/) foi desenvolvido pela MonsterBed em parceria com a Empresa Brasileira de Pesquisa Agropecuária (Embrapa), uma instituição pública de pesquisa vinculada ao Ministério da Agricultura.\nO jogo, que tem como público alvo crianças de 8 a 12 anos, visa ensinar a importância da preservação da natureza. Isso acontece através de uma trilha ecológica da Embrapa, onde o jogador deverá percorrê-la aprendendo a importância de mantê-la limpa e conhecendo as árvores nativas que a compõe.\nÉ um jogo plataforma 3D com temática educacional, onde o jogador irá escolher entre 2 personagens: Teo ou Neila. Depois, viverá uma grande aventura pela trilha, recolhendo o lixo encontrado e enfrentando inimigos. No fim, terá que enfrentar o temível vilão de lixo para salvar seu amigo.", actual.Content);
